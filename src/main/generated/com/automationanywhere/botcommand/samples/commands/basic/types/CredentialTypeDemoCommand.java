...
public final class CredentialTypeDemoCommand implements BotCommand {
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    if(parameters.containsKey("credentials") && parameters.get("credentials") != null && parameters.get("credentials").get() != null) {
      ...
      if(!(convertedParameters.get("credentials") instanceof SecureString)) {
    ...
    try {
      command.printCredentials((SecureString)convertedParameters.get("credentials"));Optional<Value> result = Optional.empty();
